...
import com.otaliastudios.zoom.internal.matrix.MatrixUpdate.Companion.obtain
...
internal class MatrixUpdate private constructor(
    ...
    internal val needEnsurePan: Boolean,
    ...
    internal class Builder {
        ...
        internal var needEnsurePan: Boolean = true
        ...
        internal fun build(): MatrixUpdate {
            return MatrixUpdate(
                zoom = zoom,
                isZoomRelative = zoomRelative,
                canOverZoom = overZoom,
                pan = pan,
                scaledPan = scaledPan,
                isPanRelative = panRelative,
                canOverPan = overPan,
                needEnsurePan = needEnsurePan,
                pivotX = pivotX,
                pivotY = pivotY,
                notify = notify
            )
