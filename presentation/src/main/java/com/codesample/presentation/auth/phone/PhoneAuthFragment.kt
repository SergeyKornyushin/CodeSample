...
import com.codesample.presentation.auth.phone.model.CountryPhoneCode
import com.codesample.presentation.databinding.FragmentPhoneAuthBinding
import com.codesample.presentation.common.extentions.ClickablePart
import com.codesample.presentation.common.extentions.changeErrorState
import com.codesample.presentation.common.extentions.handleBackClick
import com.codesample.presentation.common.extentions.openLinkInBrowser
import com.codesample.presentation.common.extentions.setClickableParts
import com.codesample.presentation.common.extentions.setHomeAsStartDestination
import com.codesample.presentation.common.extentions.setMaxLength
...
class PhoneAuthFragment :
    ...
    companion object {
        ...
        fun createArgBundle(isFirstLaunch: Boolean): Bundle {
            return bundleOf(PhoneAuthFragment.Companion.IS_FIRST_LAUNCH_BUNDLE_KEY to isFirstLaunch)
        }
    }
}